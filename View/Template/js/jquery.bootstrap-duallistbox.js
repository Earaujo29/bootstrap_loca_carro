;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: 'Mover o selecionado',
      moveAllLabel: 'Mover Todos',
      removeSelectedLabel: 'Remover o selecionado',
      ...
      infoText: 'Itens {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">Pesquisa</span> {0} de {1}', // when not all of the options are visible due to the filter
